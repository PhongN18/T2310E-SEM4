...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Order_Order$fromJson(json) {
      return new A.Order(A._asString(json.$index(0, "Item")), A._asString(json.$index(0, "ItemName")), A._asNum(json.$index(0, "Price")), A._asString(json.$index(0, "Currency")), A._asInt(json.$index(0, "Quantity")));
    },
    Order: function Order(t0, t1, t2, t3, t4) {
      var _ = this;
      _.item = t0;
      _.itemName = t1;
      _.price = t2;
    ...
    main() {
      var t1, search, form, msg, downloadBtn,
        decoded = J.cast$1$0$ax(type$.List_dynamic._as(B.C_JsonCodec.decode$2$reviver('[{"Item": "A1000","ItemName": "Iphone 15","Price": 1200,"Currency":"USD","Quantity":1},{"Item": "A1001","ItemName": "Iphone 16","Price":1500,"Currency": "USD","Quantity":1}]', null)), type$.Map_String_dynamic);
      B.JSArray_methods.clear$0($._orders);
      t1 = decoded.$ti;
      B.JSArray_methods.addAll$1($._orders, new A.MappedListIterable(decoded, t1._eval$1("Order(ListBase.E)")._as(new A.main_closure()), t1._eval$1("MappedListIterable<ListBase.E,Order>")));
      A._renderTable($._orders);
      t1 = init.G;
      search = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#search"));
      if (search != null)
        search.addEventListener("input", A._functionToJS1(new A.main_closure0(search)));
      form = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#orderForm"));
      msg = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#formMsg"));
      if (form != null)
        form.addEventListener("submit", A._functionToJS1(new A.main_closure1(msg, search, form)));
      downloadBtn = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#downloadBtn"));
      if (downloadBtn != null)
        downloadBtn.addEventListener("click", A._functionToJS1(new A.main_closure2()));
    },
    _renderTable(list) {
      var t2, tr, td, _i, o, t3,
        t1 = init.G,
        tbody = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#ordersBody"));
      if (tbody == null)
        return;
      tbody.innerHTML = "";
      t2 = list.length;
      if (t2 === 0) {
        tr = A._asJSObject(A._asJSObject(t1.document).createElement("tr"));
        td = A._asJSObject(A._asJSObject(t1.document).createElement("td"));
        td.colSpan = 5;
        td.className = "empty";
      ...
      for (_i = 0; _i < list.length; list.length === t2 || (0, A.throwConcurrentModificationError)(list), ++_i) {
        o = list[_i];
        tr = A._asJSObject(A._asJSObject(t1.document).createElement("tr"));
        td = A._asJSObject(A._asJSObject(t1.document).createElement("td"));
        td.textContent = o.item;
        tr.append(td);
        td = A._asJSObject(A._asJSObject(t1.document).createElement("td"));
        td.textContent = o.itemName;
        tr.append(td);
        t3 = B.JSNumber_methods.toString$0(o.price);
        td = A._asJSObject(A._asJSObject(t1.document).createElement("td"));
        td.textContent = t3;
        tr.append(td);
        td = A._asJSObject(A._asJSObject(t1.document).createElement("td"));
        td.textContent = o.currency;
        tr.append(td);
        t3 = B.JSInt_methods.toString$0(o.quantity);
        td = A._asJSObject(A._asJSObject(t1.document).createElement("td"));
        td.textContent = t3;
        tr.append(td);
        tbody.append(tr);
    ...
    _getValue(selectors) {
      var el, v, t1, t2, t3, _i, sel, t4, exception;
      for (t1 = selectors.length, t2 = type$.JSObject, t3 = init.G, _i = 0; _i < selectors.length; selectors.length === t1 || (0, A.throwConcurrentModificationError)(selectors), ++_i) {
        sel = selectors[_i];
        el = A._asJSObjectQ(A._asJSObject(t3.document).querySelector(sel));
        if (t2._is(el)) {
          t1 = A._asString(el.value);
          return t1;
        }
        if (t2._is(el)) {
          t1 = A._asString(el.value);
    ...
    _setMsg(el, text, success) {
      var t1, t2;
      if (el == null)
        return;
      el.textContent = text;
      t1 = A._asJSObject(el.style);
      t2 = success ? "#10b981" : "#eab308";
      t1.setProperty("color", t2);
    },
    _normalizeOrderMap(m) {
      var itemName, priceAny, currency, qtyAny, price, qty, _null = null,
        t1 = new A._normalizeOrderMap_pick(m),
        t2 = type$.JSArray_String,
        t3 = t1.call$1(A._setArrayType(["Item", "item"], t2)),
        item = t3 == null ? _null : J.toString$0$(t3);
      if (item == null)
        item = "";
      t3 = t1.call$1(A._setArrayType(["ItemName", "item_name", "itemName"], t2));
      itemName = t3 == null ? _null : J.toString$0$(t3);
      if (itemName == null)
        itemName = "";
      priceAny = t1.call$1(A._setArrayType(["Price", "price"], t2));
      t3 = t1.call$1(A._setArrayType(["Currency", "currency"], t2));
      currency = t3 == null ? _null : J.toString$0$(t3);
      if (currency == null)
        currency = "";
      qtyAny = t1.call$1(A._setArrayType(["Quantity", "quantity", "qty"], t2));
      if (typeof priceAny == "number")
        price = priceAny;
      else {
        t1 = priceAny == null ? _null : J.toString$0$(priceAny);
        t1 = A.num_tryParse(t1 == null ? "0" : t1);
        price = t1 == null ? 0 : t1;
      }
      if (A._isInt(qtyAny))
        qty = qtyAny;
      else {
        t1 = qtyAny == null ? _null : J.toString$0$(qtyAny);
        t1 = A.Primitives_parseInt(t1 == null ? "0" : t1, _null);
        qty = t1 == null ? 0 : t1;
      }
      return A.LinkedHashMap_LinkedHashMap$_literal(["Item", item, "ItemName", itemName, "Price", price, "Currency", currency, "Quantity", qty], type$.String, type$.dynamic);
    },
    ...
    _normalizeOrderMap_pick: function _normalizeOrderMap_pick(t0) {
      this.m = t0;
    },
  ...
  A.Order.prototype = {
    toJson$0() {
      var _this = this;
      return A.LinkedHashMap_LinkedHashMap$_literal(["Item", _this.item, "ItemName", _this.itemName, "Price", _this.price, "Currency", _this.currency, "Quantity", _this.quantity], type$.String, type$.dynamic);
    }
  };
  A.main_closure.prototype = {
    call$1(m) {
      return A.Order_Order$fromJson(A._normalizeOrderMap(type$.Map_String_dynamic._as(m)));
    },
    $signature: 6
  };
  A.main_closure0.prototype = {
    call$1(_) {
      var t1, q, filtered, t2;
      A._asJSObject(_);
      t1 = A._asString(this.search.value);
      q = B.JSString_methods.trim$0(t1).toLowerCase();
      if (q.length === 0)
        filtered = $._orders;
      else {
        t1 = A._arrayInstanceType($._orders);
        t2 = t1._eval$1("WhereIterable<1>");
        t1 = A.List_List$_of(new A.WhereIterable($._orders, t1._eval$1("bool(1)")._as(new A.main__closure2(q)), t2), t2._eval$1("Iterable.E"));
        t1.$flags = 1;
        filtered = t1;
      }
      A._renderTable(filtered);
    },
    $signature: 1
  };
  A.main__closure2.prototype = {
    call$1(o) {
      return B.JSString_methods.contains$1(type$.Order._as(o).itemName.toLowerCase(), this.q);
    },
    $signature: 2
  };
  A.main_closure1.prototype = {
    call$1(e) {
      var t1, itemStr, itemName, priceStr, currency, qtyStr, price, qty, newOrder, q, t2, _this = this;
      A._asJSObject(e).preventDefault();
      t1 = type$.JSArray_String;
      itemStr = A._getValue(A._setArrayType(["#fItem"], t1));
      itemName = A._getValue(A._setArrayType(["#fItemName", "#fName"], t1));
      priceStr = A._getValue(A._setArrayType(["#fPrice"], t1));
      currency = A._getValue(A._setArrayType(["#fCurrency"], t1));
      qtyStr = A._getValue(A._setArrayType(["#fQuantity", "#fQty"], t1));
      if (itemStr.length === 0 || itemName.length === 0 || priceStr.length === 0 || currency.length === 0 || qtyStr.length === 0) {
        A._setMsg(_this.msg, "Please fill all fields correctly.", false);
        return;
      }
      price = A.num_tryParse(priceStr);
      qty = A.Primitives_parseInt(qtyStr, null);
      if (price == null || price < 0 || qty == null || qty <= 0) {
        A._setMsg(_this.msg, "Invalid price/quantity.", false);
        return;
      }
      if (B.JSArray_methods.any$1($._orders, new A.main__closure0(itemStr))) {
        A._setMsg(_this.msg, 'Item "' + itemStr + '" already exists.', false);
        return;
      }
      newOrder = A.Order_Order$fromJson(A._normalizeOrderMap(A.LinkedHashMap_LinkedHashMap$_literal(["Item", itemStr, "ItemName", B.JSString_methods.trim$0(itemName), "Price", price, "Currency", B.JSString_methods.trim$0(currency).toUpperCase(), "Quantity", qty], type$.String, type$.dynamic)));
      B.JSArray_methods.add$1($._orders, newOrder);
      t1 = _this.search;
      t1 = t1 == null ? null : A._asString(t1.value);
      q = B.JSString_methods.trim$0(t1 == null ? "" : t1).toLowerCase();
      if (q.length === 0)
        t1 = $._orders;
      else {
        t1 = A._arrayInstanceType($._orders);
        t2 = t1._eval$1("WhereIterable<1>");
        t1 = A.List_List$_of(new A.WhereIterable($._orders, t1._eval$1("bool(1)")._as(new A.main__closure1(q)), t2), t2._eval$1("Iterable.E"));
      }
      A._renderTable(t1);
      _this.form.reset();
      A._setMsg(_this.msg, "Inserted order " + newOrder.item + ".", true);
    },
    $signature: 1
  };
  A.main__closure0.prototype = {
    call$1(o) {
      return type$.Order._as(o).item.toLowerCase() === this.itemStr.toLowerCase();
    },
    $signature: 2
  };
  ...
  A.main_closure2.prototype = {
    call$1(_) {
      var t1, t2, jsonList, a;
      A._asJSObject(_);
      t1 = A._arrayInstanceType($._orders);
      t2 = t1._eval$1("MappedListIterable<1,Map<String,@>>");
      jsonList = A.List_List$_of(new A.MappedListIterable($._orders, t1._eval$1("Map<String,@>(1)")._as(new A.main__closure()), t2), t2._eval$1("ListIterable.E"));
      t1 = A._Uri__uriEncode(2, A._JsonStringStringifier_stringify(jsonList, null, "  "), B.C_Utf8Codec, false);
      t2 = init.G;
      a = A._asJSObject(A._asJSObject(t2.document).createElement("a"));
      a.setAttribute("href", "data:application/json;charset=utf-8," + t1);
      a.setAttribute("download", "order.json");
      A._asJSObject(a.style).setProperty("display", "none");
  ...
  A.main__closure.prototype = {
    call$1(o) {
      return type$.Order._as(o).toJson$0();
    },
    $signature: 7
  };
  A._normalizeOrderMap_pick.prototype = {
    call$1(keys) {
      var t1, t2, _i, k;
      type$.List_String._as(keys);
      for (t1 = keys.length, t2 = this.m, _i = 0; _i < keys.length; keys.length === t1 || (0, A.throwConcurrentModificationError)(keys), ++_i) {
        k = keys[_i];
        if (t2.containsKey$1(k) && t2.$index(0, k) != null)
          return t2.$index(0, k);
      }
      return null;
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Iterable, A.CastIterator, A.Error, A.ListIterator, A.WhereIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A.Codec, A.Converter, A._JsonStringifier, A._JsonPrettyPrintMixin, A._Utf8Encoder, A.StackOverflowError, A.FormatException, A.Null, A.StringBuffer, A.Order]);
    ...
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.WhereIterable]);
    _inheritMany(A._CastIterableBase, [A.CastIterable, A.__CastListBase__CastIterableBase_ListMixin]);
    _inherit(A._EfficientLengthCastIterable, A.CastIterable);
    _inherit(A._CastListBase, A.__CastListBase__CastIterableBase_ListMixin);
    _inherit(A.CastList, A._CastListBase);
    _inheritMany(A.Error, [A.LateError, A.TypeError, A.JsNoSuchMethodError, A.UnknownJsTypeError, A.RuntimeError, A._Error, A.JsonUnsupportedObjectError, A.AssertionError, A.ArgumentError, A.UnsupportedError, A.UnimplementedError, A.ConcurrentModificationError]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.main_closure, A.main_closure0, A.main__closure2, A.main_closure1, A.main__closure0, A.main__closure1, A.main_closure2, A.main__closure, A._normalizeOrderMap_pick]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inheritMany(A.MapBase, [A.JsLinkedHashMap, A._JsonMap]);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A.MapBase_mapToString_closure, A._JsonStringifier_writeMap_closure, A._JsonPrettyPrintMixin_writeMap_closure]);
    ...
    _inheritMany(A.Converter, [A.JsonDecoder, A.Utf8Encoder]);
...
;
  ...
  (function staticFields() {
    ...
    $._orders = A._setArrayType([], A.findType("JSArray<Order>"));
  })();
